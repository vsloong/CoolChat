package com.cooloongwu.coolchat.keyboard;
...
/**
 * Created by CooLoongWu on 2016-12-28 17:44.
 */
...
public class QqEmoticonsKeyBoard extends AutoHeightLayout implements EmoticonsFuncView.OnEmoticonsPageViewListener,
    ...
    public void resetIcon() {
        btnVoice.setImageResource(R.drawable.qq_skin_aio_panel_emotion);
        btnPtv.setImageResource(R.drawable.qq_skin_aio_panel_emotion);
        btnImage.setImageResource(R.drawable.qq_skin_aio_panel_emotion);
        btnCamera.setImageResource(R.drawable.qq_skin_aio_panel_emotion);
        btnHongbao.setImageResource(R.drawable.qq_skin_aio_panel_emotion);
        btnEmoticon.setImageResource(R.drawable.qq_skin_aio_panel_emotion);
        btnPlug.setImageResource(R.drawable.qq_skin_aio_panel_emotion);
    }
    ...
    public void onFuncChange(int key) {
        ...
        switch (key) {
            case FUNC_TYPE_PTT:
                btnVoice.setImageResource(R.mipmap.qq_skin_aio_panel_emotion_press);
                break;
            case FUNC_TYPE_PTV:
                btnPtv.setImageResource(R.mipmap.qq_skin_aio_panel_emotion_press);
                break;
            case FUNC_TYPE_IMAGE:
                btnImage.setImageResource(R.mipmap.qq_skin_aio_panel_emotion_press);
                break;
            case FUNC_TYPE_CAMERA:
                btnCamera.setImageResource(R.mipmap.qq_skin_aio_panel_emotion_press);
                break;
            case FUNC_TYPE_HONGBAO:
                btnHongbao.setImageResource(R.mipmap.qq_skin_aio_panel_emotion_press);
                break;
            case FUNC_TYPE_EMOTICON:
                btnEmoticon.setImageResource(R.mipmap.qq_skin_aio_panel_emotion_press);
                break;
            case FUNC_TYPE_PLUG:
                btnPlug.setImageResource(R.mipmap.qq_skin_aio_panel_emotion_press);
                break;
        }
    }
